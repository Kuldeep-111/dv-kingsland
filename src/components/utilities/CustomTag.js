export const  Pera = ({ children ,CustomClass}) => (
  ...
  export const  Pera2 = ({ children ,CustomClass}) => (
    <p className={`${CustomClass} text-[#202020] text-justify font-montserrat text-[12px] md:text-[14px] font-normal leading-[20px] md:leading-[30px] tracking-[1px] capitalize`}>{children}</p>
  );
