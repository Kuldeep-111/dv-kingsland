...
const CustomForm = ({CustomClass}) => {
  ...
  return (
    <form className={`flex flex-col  gap-6 border-2 border-[#705118] py-[20px] px-[20px] md:py-[25px] md:px-[25px] xxl:py-[40px] xxl:px-[50px]  bg-[#7051181A] w-full max-w-[500px] mx-auto ${CustomClass}`}>
