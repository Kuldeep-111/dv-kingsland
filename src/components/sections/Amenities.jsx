...
const amenitiesData = [
  {
    ...
    title: 'Relax and enjoy our beautiful pool area.'
  },
  {
  ...
  },
  {
    ...
    title: 'Safe and fun environment for kids.'
  },
  {
...
<section className="py-[50px] bg-[#EBEAE6] relative" id="amenities">
  ...
  <div className="container mx-auto relative z-20">
    ...
    <div className="w-full md:w-[60%] mx-auto px-[15px] md:px-[0] mb-[25px] xxl:mb-[50px]">
