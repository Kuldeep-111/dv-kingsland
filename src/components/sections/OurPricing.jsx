...
const OurPricing = ({ onEnquireClick }) => {
  return (
    <section
      className="pt-[50px] xxl:py-[80px] bg-[#EBEAE6] relative"
      id="pricing"
    >
      <Image
      ...
      <div className="container mx-auto">
        ...
        <div className=" w-full md:w-[80%] xxl:w-[60%] mx-auto mb-[25px] xxl:mb-[50px] md:px-[0]">
          <Pera2 CustomClass="!text-center !text-[12px] md:!text-[14px] !leading-[20px]">
            {" "}
            Timeless design. Lasting value.{" "}
          </Pera2>
          <Pera2 CustomClass="!text-center !text-[12px] md:!text-[14px] !leading-[20px]">
            {" "}
            Our curated luxury homes are priced to Reflect the sophistication
            you deserve
          </Pera2>
        </div>
      </div>
      ...
      <div className="relative pb-[50px] sm:pb-[150px] md:pb-[0]">
        ...
        <div className="absolute top-0 left-0 w-full hidden md:flex justify-center align-center h-full">
          <div className="w-full flex flex-col items-center justify-center text-center gap-[0px] h-[80%]">
            ...
            <Price
              text={" ₹ 5.10 cr*"}
              CustomClass="leading-[30px] mt-[20px] gradient-text"
            />
            <span>onwards</span>
